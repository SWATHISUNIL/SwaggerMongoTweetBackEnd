...
namespace TweetApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<TweetAppContext>(o =>
            //{
            //    o.UseSqlServer(Configuration["ConnectionStrings:TweetAppConnectionString"]);
            //});
            services.Configure<TweetAppConfig>(Configuration.GetSection("TweetAppConfig"));
            services.AddScoped<IuserService, UserService>();
            services.AddScoped<ItweetInterface, TweetService>();
